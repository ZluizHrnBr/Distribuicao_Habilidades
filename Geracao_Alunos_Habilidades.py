...
alunos_habilidades = int(input("Digite a quantidade de alunos para selecionar as habilidades ? "))

# Definição de habilidades dos desenvolvedores (nome: [habilidades])
desenvolvedores = {f'Aluno{i}': [] for i in range(0, alunos_habilidades)}
...
nome_arquivo = "alunos_habilidades.csv"
